...
//蛇的皮肤
function drawRect(x, y, wid, hig, fillColor, borderWidth, borderColor){
    ctx.beginPath();
    ctx.moveTo(x, y);
    ctx.lineTo(x + wid, y);
    ctx.lineTo(x + wid, y + hig);
    ctx.lineTo(x, y + hig);    
    ctx.closePath();
...
var activeDot = function(x, y) {
    ...
    drawRect(x * 10, y * 10, 6, 6, "#CAF7F7", 2 ,"#eee");
}

//食物样式
var foodStyle = function(x, y) {
